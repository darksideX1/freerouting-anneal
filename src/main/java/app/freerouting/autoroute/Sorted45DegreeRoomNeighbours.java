    ...
    if (try_remove_edge_lines) {
      ...
      if (FRLogger.isTraceEnabled()) {
        FRLogger.trace("ROOM_EDGE_REMOVE start"
            ...
            + ", room_bounds=" + FRLogger.formatBounds(room_oct.bounding_box()));
      }
      ...
      if (FRLogger.isTraceEnabled()) {
        FRLogger.trace("ROOM_EDGE_REMOVE enlarged"
            + ", net=" + p_net_no
            + ", layer=" + curr_incomplete_room.get_layer()
            + ", enlarged_bounds=" + FRLogger.formatBounds(enlarged_oct.bounding_box()));
      }
      if (FRLogger.isTraceEnabled()) {
        FRLogger.trace("ROOM_EDGE_REMOVE contained"
            ...
            + ", bounds=" + FRLogger.formatBounds(curr_incomplete_room.get_contained_shape().bounding_box()));
      }
        ...
        if (new_room
          ...
          if (FRLogger.isTraceEnabled()) {
            FRLogger.trace("ROOM_EDGE_REMOVE applied"
                + ", net=" + p_net_no
                + ", layer=" + curr_incomplete_room.get_layer()
                + ", old_bounds=" + FRLogger.formatBounds(room_oct.bounding_box())
                + ", new_bounds=" + FRLogger.formatBounds(new_room.get_shape().bounding_box()));
          }
